    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
      ...
      <main className="flex-grow max-w-4xl mx-auto px-4 py-8 w-full">
        <div className="card p-6 md:p-8">
          <h2 className="text-2xl font-bold text-primary mb-2">Babber Trading and Company</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-6">Version 1.0.0 | Established 2024</p>
          <div className="space-y-6">
            <div><h3 className="text-xl font-semibold text-primary mb-2">Our Mission</h3><p>Babber Trading and Company app is designed to simplify crop transaction calculations for mandi commission agents, farmers, and traders. We aim to digitize and streamline the traditional mandi transaction process, making it faster, transparent, and more efficient. Our mission is to empower every mandi stakeholder with technology that saves time and reduces errors.</p></div>
